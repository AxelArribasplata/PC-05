...
# Parte 1
print("============================================")
df_airbnb = pd.read_csv("C:/Users/AXEL/Programación Python/Python DATUX/PythonFundamentos-master/Modulo5/Ejercicios/src/pandas/airbnb.csv")
...
if not os.path.isdir('C:/Users/AXEL/Programación Python/Python DATUX/PythonFundamentos-master/Modulo5/Ejercicios/src/pandas'):
    os.mkdir('C:/Users/AXEL/Programación Python/Python DATUX/PythonFundamentos-master/Modulo5/Ejercicios/src/pandas')
    df_airbnb[condition].to_excel('C:/Users/AXEL/Programación Python/Python DATUX/PythonFundamentos-master/Modulo5/Ejercicios/src/roberto.xls',
...
print("================CASO 3================")
filtrar = (df_airbnb["room_type"] == 'Shared room') & (df_airbnb["price"] <= 50) & (df_airbnb["overall_satisfaction"] == 5)
